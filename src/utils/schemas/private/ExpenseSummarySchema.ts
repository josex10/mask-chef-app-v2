...
export const ExpenseSummarySchema = z.object({
  CodigoTipoMoneda: z
    ...
    TotalServGravados: z.coerce.number({ message: EMessages.inputErrorTypeNumber }),
    TotalServExentos: z.coerce.number({ message: EMessages.inputErrorTypeNumber }),
    TotalServExonerado: z.coerce.number({ message: EMessages.inputErrorTypeNumber }),
    TotalMercanciasGravadas: z.coerce.number({ message: EMessages.inputErrorTypeNumber }),
    TotalMercanciasExentas: z.coerce.number({ message: EMessages.inputErrorTypeNumber }),
    TotalMercExonerada: z.coerce.number({ message: EMessages.inputErrorTypeNumber }),
    ...
    TotalComprobante: z.coerce.number({ message: EMessages.inputErrorTypeNumber }),
});
